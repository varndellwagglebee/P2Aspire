...
namespace P2Aspire.ServiceDefaults;
...
public static class SerilogExtensions
{
    ...
    /// </summary>
    /// <remarks>
    /// âš  This method MUST be called before the <see cref="OpenTelemetryLoggingExtensions.AddOpenTelemetry(ILoggingBuilder)"/> method to still send structured logs via OpenTelemetry. âš 
    /// </remarks>
